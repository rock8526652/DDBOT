...
var (
	CommitId  = "UNKNOWN"
	BuildTime = "2024/06/232024-6-23 18:00:00"
	Tags      = "1.1.5-300s"
)
...
func CheckUpdate() string {
	...
	err := requests.Get("https://api.github.com/repos/rock8526652/DDBOT/releases/latest", nil, &m, opts...)
	if err != nil {
	...
	if compareVersion(Tags, latestTagName) {
		logrus.Infof("更新检测完成：DDBOT有可用更新版本【%v】，请前往 https://github.com/rock8526652/DDBOT/releases 查看详细信息\n", latestTagName)
