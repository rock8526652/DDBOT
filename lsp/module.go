...
import (
	...
	"github.com/rock8526652/DDBOT/image_pool"
	"github.com/rock8526652/DDBOT/image_pool/local_pool"
	"github.com/rock8526652/DDBOT/image_pool/lolicon_pool"
	localdb "github.com/rock8526652/DDBOT/lsp/buntdb"
	"github.com/rock8526652/DDBOT/lsp/cfg"
	...
	"github.com/rock8526652/DDBOT/lsp/version"
	"github.com/rock8526652/DDBOT/proxy_pool"
	"github.com/rock8526652/DDBOT/proxy_pool/local_proxy_pool"
	"github.com/rock8526652/DDBOT/proxy_pool/py"
...
func (l *Lsp) NewVersionNotify(newVersionChan <-chan string) {
	...
	for newVersion := range newVersionChan {
		...
		m := mmsg.NewMSG()
		m.Textf("DDBOT管理员您好，DDBOT有可用更新版本【%v】，请前往 https://github.com/rock8526652/DDBOT/releases 查看详细信息\n\n", newVersion)
